...
if ($_POST['buat']) {
  ...
  mysqli_query($koneksi, "INSERT INTO cp$id (no, nama_cp, visi_misi) VALUES ('1', 'Pemimpin', 'Visi-Misi')");
  mysqli_query($koneksi, "INSERT INTO cp$id (no, nama_cp, visi_misi) VALUES ('2', 'Pemimpin', 'Visi-Misi')");
  mysqli_query($koneksi, "INSERT INTO cp$id (no, nama_cp, visi_misi) VALUES ('3', 'Pemimpin', 'Visi-Misi')");
  mysqli_query($koneksi, "INSERT INTO cp$id (no, nama_cp, visi_misi) VALUES ('4', 'Pemimpin', 'Visi-Misi')");
  mysqli_query($koneksi, "INSERT INTO cp$id (no, nama_cp, visi_misi) VALUES ('5', 'Pemimpin', 'Visi-Misi')");
